  ...
  describe("Check function showMenuStoredRule: ", function () {
    ...
    it.only("Check function runs without exceptions: ", function () {
      ...
      const expectedResult =
        '<div><div class="section configRule"><button title="Delete" class="button squareButton"><img src="/icons/trash.png"></button><button title="Edit" class="button squareButton"><img src="/icons/edit.png"></button><p>old value ---&gt; new value</p></div><div class="section configRule hidden"><button title="Update" class="button squareButton"><img src="/icons/ok.png"></button><button title="Cancel update" class="button squareButton"><img src="/icons/cancel.png"></button><input type="text"><input type="text"></div></div>';
