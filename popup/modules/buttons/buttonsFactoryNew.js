/* TODO  replace buttonsFactory with buttonsFactoryNew, rename drop New */
...
function getButton(buttonId) {
  ...
  switch (buttonId) {
    ...
    default:
      throw new ModuleButtonsExceptions.ButtonNameInvalidException(
        `Invalid buttonId: ${buttonId}`,
      );
  }
}
