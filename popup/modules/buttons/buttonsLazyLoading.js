...
class ButtonConfigurationLazyLoading extends ModuleButtonsInterface.ButtonClicked {
  static get _buttonIdHtml() {
    return "buttonConfigLazyLoading";
  }
...
class ButtonAddLazyLoading extends ModuleButtonsInterface.ButtonClicked {
  static get _buttonIdHtml() {
    return "buttonAddLazyLoading";
  }

  get run() {
    const lazyLoadingTimeToSave =
      _getValidLazyLoadingTimeToSaveAndNotifyBadValue();
...
export { ButtonAddLazyLoading, ButtonConfigurationLazyLoading };
