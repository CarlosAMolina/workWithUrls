...
class ButtonOnOff extends ModuleButtonsInterface.ButtonClicked {
  ...
  setStyleColorLabelChecked(style, color, label, checked) {
    ModuleDom.getElementById(this.constructor.buttonIdHtml).style.background =
      style;
...
class ButtonDecodeUrls extends ButtonOnOff {
  static get _buttonIdHtml() {
    return "buttonDecodeUrls";
  }
  static get _buttonIdStorage() {
    return "buttonDecodeUrlsIsOn";
  }
}

class ButtonOpenPaths extends ButtonOnOff {
  static get _buttonIdHtml() {
    return "buttonOpenPaths";
  }
  static get _buttonIdStorage() {
    return "buttonOpenPathsIsOn";
  }
}

class ButtonOpenRules extends ButtonOnOff {
  static get _buttonIdHtml() {
    return "buttonOpenRules";
  }
  static get _buttonIdStorage() {
    return "buttonOpenRulesIsOn";
  }
...
export { ButtonDecodeUrls, ButtonOpenPaths, ButtonOpenRules };
