...
import * as ModuleButtonsFactoryNew from "../../../popup/modules/buttons/buttonsFactoryNew.js";
...
// TODO replace showMenuStoredRule with showMenuStoredRuleNew
function showMenuStoredRuleNew(rule, rules) {
  console.log("Init showMenuStoredRule");
  const ruleMenu = _getRuleMenu(rule);
  ModuleDom.getInfoContainer().appendChild(ruleMenu.element);
